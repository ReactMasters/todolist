...
import { CreateTagInput, CreateTagOutput } from "./dto/create-tag.input";
import { ListTagsOutput } from "./dto/list-tags.input";
...
export class TagResolver {
    ...
    async createTag(@Args({ name: 'createTagInput', type: () => CreateTagInput }) createTagInput: CreateTagInput) {
